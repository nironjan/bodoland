...
const CommentInfoCard = ({
  ...
  getAllComments,
  onDelete,
  isSubReply = false, // ✅ default false
}) => {
    ...
    <>
      <div className="bg-white p-3 rounded-lg cursor-pointer group mb-5">
        <div className="grid grid-cols-12 gap-3">
          <div className="col-span-12 md:col-end-8 order-2 md:order-1">
                ...
                <div className="flex items-center gap-3 mt-1.5">
                  {!isSubReply && (
                    <>
                      ...
                      <button
                        className="flex items-center gap-1.5 text-[13px] font-medium text-sky-600 bg-sky-50 px-3 py-0.5 rounded-full hover:bg-sky-500 hover:text-white cursor-pointer"
        ...
        {!isSubReply && showReplyForm && (
          <CommentReplyInput
            user={user}
            authorName={authorName} // ✅ fixed typo
            content={content}
            replyText={replyText}
