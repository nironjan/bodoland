...
const CommentReplyInput = ({
  ...
  // Gnerate Reply using AI
  const generateReply = async () => {
    setLoading(true);

    try {
      const aiResponese = await axiosInstance.post(
      ...
      const generatedReply = aiResponese.data;
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="flex-1">
          <Input
            ...
            label={type == "new" ? autorName : `Reply to ${autorName}`}
        ...
        {!disableAutoGen && (
          ...
          >
            ...
            {loading ? "Generating..." : "Generated Reply"}
          </button>
        )}
      </div>
    </div>
