...
const CommentInfoCard = ({
  ...
  const [showSubRepliies, setShowSubReplies] = useState(false);

  // Handle cenceling a reply
      ...
      <div className="grid grid-cols-12 gap-3">
          ...
          <div className="flex flex-col md:flex-row items-start gap-3">
            ...
            <div className="flex-1">
              <div className="flex items-center gap-1">
                ...
                <span className="text-[12px] text-shadow-gray-500 font-medium">
                  {updatedOn}
                </span>
              </div>
                ...
                {!isSubReply && (
                  <>
                    ...
                    >
                      ...
                      <LuChevronDown
                        className={`${showSubRepliies ? "rotate-180" : ""}`}
                      />
                    </button>{" "}
                  </>
                )}
        ...
        {!isSubReply && (
          <div className="col-span-12 md:col-span-5 order-1 md:order-2 flex items-center gap-4">
            ...
            <div className="flex-1">
              <div className="flex items-center gap-1">
                <h4 className="tex-xs text-gray-800 font-medium">
                  {post?.title}
                </h4>
              </div>
            </div>
